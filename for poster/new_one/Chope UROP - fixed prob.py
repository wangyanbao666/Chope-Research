...
def main():
    ...
    num_customer = 1000
    capacity = 150
    hyperparameters = [[num_customer, 90, 8, 25, 5, 1], [num_customer, 100, 8, 25, 5, 1],
                       [num_customer, 110, 8, 25, 5, 1],
                       [num_customer, 120, 8, 25, 5, 1], [num_customer, 130, 8, 25, 5, 1]]
    ...
    for hyperparam in hyperparameters:
        ...
        plt.savefig('waiting time/change capacity/Run number {} Waiting time against probability'.format(g_counter),
